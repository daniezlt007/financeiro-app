...
class VendaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'parceiro' => 'nullable|string|in:THAI VEICULOS,DUNORTE ANANINDEUA,DU NORTE BELEM,DU NORTE PAC,FÊNIX,PSA ANANINDEUA,PSA BELÉM,FIAT,GWM,TROPICAL NISSAN ANANINDEUA,TROPICAL NISSAN BELÉM,UNIQUE',
