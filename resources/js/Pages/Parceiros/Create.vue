<template>
  <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="mb-6">
      <h1 class="text-2xl font-bold text-gray-900">Novo Parceiro</h1>
      <p class="text-gray-600 mt-1">Cadastre um novo parceiro</p>
    </div>

    <Card title="Dados do Parceiro" variant="elevated">
      <form @submit.prevent="form.post(route('parceiros.store'))" class="space-y-4">
        <div>
...
const form = useForm({ nome_parceiro: '' })
</script>
